...
document
  .querySelectorAll(".btn-primary, .btn-secondary, .cta-btn")
  .forEach((button) => {
    button.addEventListener("click", (e) => {
      ...
      if (
        ...
        button.textContent.includes("Start Managing")
      ) {
...
console.log(
  "Features: Event Management, QR Check-in, Gamification, Real-time Updates"
);
